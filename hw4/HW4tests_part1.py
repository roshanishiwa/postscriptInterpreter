...
class HW4tests_part1(unittest.TestCase):
    ...
    def test_getinterval2(self):
        #(RoshaniShiwakoti) 4 6
        opPush('(RoshaniShiwakoti)')
        opPush(4)
        opPush(6)
        getinterval()
        self.assertEqual(opPop(), '(aniShi)')
        self.assertTrue(len(opstack)==0)
    ...
    def test_putinterval4(self):
        #(RoshaniShiwakoti) dup 13 (355) putinterval
        opPush('(RoshaniShiwakoti)')
        dup()
        opPush(13)
        opPush('(355)')
        putinterval()
        self.assertEqual(opPop(), '(RoshaniShiwak355)')
        self.assertTrue(len(opstack)==0) 
    ...
    def test_search3(self):
        # RoshaniShiwakoti (355) search
        opPush('(RoshaniShiwakoti)')
        opPush('(355)')
        search()
        self.assertTrue(opPop()==False and opPop()=='(RoshaniShiwakoti)')
    ...
    def test_evaluateArray(self):
        ...
        #evaluateArray([1,'x',3,4,'y',6])
        #evaluateArray([1,1,1,'add','y','x','sub'])
        #evaluateArray(['(aBCd)',1,2,'getinterval','(BC)','eq'])
        #evaluateArray([1,2,'x','length',4,'y',350,'sub'])
        ...
        #self.assertEqual(evaluateArray([1,2,'gt']), [False])
        #self.assertEqual(evaluateArray([1,2,'x','length',4,'y',350,'sub']),[1,2,3,4,5])
    ...
    def test_beginEnd2(self):
        # /y 8 def 0 dict begin /y 3 def end x
        opPush(0)
        psDict()
        opPush("/y")
        opPush(8)
